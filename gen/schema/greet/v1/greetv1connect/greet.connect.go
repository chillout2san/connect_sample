...
const (
	...
	GreetServiceName = "schema.greet.v1.GreetService"
)
...
const (
	...
	GreetServiceGreetProcedure = "/schema.greet.v1.GreetService/Greet"
)

// GreetServiceClient is a client for the schema.greet.v1.GreetService service.
type GreetServiceClient interface {
	Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error)
}

// NewGreetServiceClient constructs a client for the schema.greet.v1.GreetService service. By
...
// Greet calls schema.greet.v1.GreetService.Greet.
...
// GreetServiceHandler is an implementation of the schema.greet.v1.GreetService service.
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/schema.greet.v1.GreetService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[v1.GreetRequest]) (*connect.Response[v1.GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("schema.greet.v1.GreetService.Greet is not implemented"))
}
